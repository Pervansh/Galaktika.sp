...
class BlipSystem {
  private:
    OrintationUnit* pImuUnit = new OrintationUnit(135);
    SystemLogger* pLogger = new SystemLogger(this, 1000);
    ...
    const int axis_x_min = 51, axis_x_max = 121, axis_x_center = 86, axis_z_min = 61, axis_z_max = 126, axis_z_center = 96;
    double kP = 0.5, kI = 0.5, kD = 0.1, last_x_e = 0, last_z_e = 0, last_x_i = 0, last_z_i = 0,
